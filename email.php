...
echo "... ".$mboxes->Nmsgs." emails found... <br/>";  ob_flush(); flush();
...
//メール処理
            ...
            // DBにあるカードと重複していれば登録しない（次の投稿の処理へ）
            if ($mail2['address']=="xxx"){  continue;  }

            // subject に $andkey が含まれなければ登録しない（次の投稿の処理へ）
            if ( !preg_match("/$andkey/",$mail2['subject']) ){  continue;  }
