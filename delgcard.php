...
$c  = optional_param('c', 0, PARAM_INT);  // ... gcard ID
...
if (has_capability('moodle/course:manageactivities', $context)){
 $gcards = $DB->get_records('sharedpanel_gcards', $delarray );
 $msg= "";
 foreach ($gcards as $gcard){
  $gcard->hidden = 1;
  $DB->update_record('sharedpanel_gcards', $gcard);
  $msg .= "gcard #".$gcard->id." deleted (hidden).<br>";
 }
}else{
...
// $DB->delete_records('sharedpanel_gcards', $delarray);
