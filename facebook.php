...
echo "<br/>importing facebook ($Groupid, key: $andkey2) ... <br/>";
ob_flush();
flush();
...
//     echo "index ".$index."/".$n2."\n"; var_dump($ret);   // debug
    ...
    if ($andkey2 && !preg_match("/$andkey2/", $ret->message)) {
        continue;
    }
...
echo "<br/><a href=\"./view.php?id=$id\"><span style='background-color:orange;padding:1ex;color:black;'><b>Importing done.</b></span></a><br/>";
ob_flush();
flush();
